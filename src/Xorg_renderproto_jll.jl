...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Xorg_renderproto_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("21e99dc2-7dba-5609-a726-b181bd3bbb6c"))
...
if best_platform === nothing
    @debug("Unable to load Xorg_renderproto; unsupported platform $(triplet(platform_key_abi()))")
else
...
end  # module Xorg_renderproto_jll
